...
from Expression3D import ExpressionModule3D
...
def matern_prior_3d(Vh_parameter,gamma = 0.1,delta = 0.1, theta0 = 2.0, theta1 = 0.5, alpha = np.pi/4, mean = None):
	anis_diff = dl.CompiledExpression(ExpressionModule3D.AnisTensor3D(), degree = 1)
	anis_diff.theta0 = theta0
	anis_diff.theta1 = theta1
	anis_diff.alpha = alpha	
