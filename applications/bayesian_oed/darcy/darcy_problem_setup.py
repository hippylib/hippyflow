...
from darcy_linear_observable import darcy_linear_observable
...
output_directory = 'data/darcy_OED_g'+str(args.gamma)+'_d'+str(args.delta)+'_nx'+str(args.nx)+'/'
...
prior = BiLaplacian2D(Vh[PARAMETER],gamma = args.gamma, delta = args.delta,robin_bc = True)
